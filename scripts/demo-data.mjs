/** Catálogo de ofertas demo (Chile). Fuente única para seed SQL/Neon y fallback de la app. */
...
export const TIPOS = ['full-time', 'full-time', 'full-time', 'part-time', 'freelance', 'practica'];
...
export function buildDemoOfertas(now = Date.now()) {
